...
| 04 | 같은 실수를 두 번 했다. 채점기준 rubric mismatch + 캐치올 충돌 자가진단 | R5 `2026-09-20-r5-typesafe-worktype.md`, R6 `2026-09-20-r6-scope-and-catchall.md` | 초안 작성 2026-09-20 |
| 05 | TypeSafe(Jev) 설정·사용법 | - | 예정 |
| 06 | 팜로그 실제 반영 | - | 반영 작업 후 |
| 07~ | Week 2 실제 농가 문장 10건 확보 후 순차 추가 | weeks/02.md 이후 | 예정 |
